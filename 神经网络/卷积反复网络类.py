...
class 双向长短期记忆神经网络(nn.Module):
    def __init__(self, 输入长度, 藏层长度, 输出长度):
        ...
        self.反复神经网络 = nn.LSTM(输入长度, 藏层长度, bidirectional=True)
...
class 卷积反复网络(nn.Module):
    def __init__(self, 通道数, 分类数, 藏层长度):
        super(卷积反复网络, self).__init__()
        ...
        self.反复神经网络 = 双向长短期记忆神经网络(128, 藏层长度, 分类数)
        # self.反复神经网络 = nn.Sequential(
